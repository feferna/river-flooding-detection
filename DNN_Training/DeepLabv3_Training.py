...
def main():
    # Training statistics:
    #     Resnet50 - PennFudanPed --> Test Loss 0.0258 - Test IoU 0.6992
    #     Resnet101 - PennFudanPed --> Test Loss 0.0255 - Test IoU 0.6779
    ...
    host.set_title("DeepLabv3 with " + backbone +  " backbone")

    plt.savefig(dataset + "training_" + backbone + ".pdf", bbox_inches='tight')
